...
/**
 * Show and edit details of a task. Also gets called when new task is created.
 */
public class DetailViewActivity extends AppCompatActivity implements DeleteDialogFragment.DeleteDialogListener, TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    private final List<ContactEntity> localContactsList = new ArrayList<>(); //list of contactEntities for this task, used in ListView
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // listen to what the most recent user event is and act accordingly.
        ...
        topAppBar.setOnMenuItemClickListener(item -> { //click listener for menu items in top app bar
        ...
        ListView listView = findViewById(R.id.contactListView); // get element in layout as container for list
        //instantiate adapter
    ...
    /**
     * Return to Overview Activity with edit intent.
     */
    ...
    /**
     * Return to Overview Activity with cancel intent.
     */
    ...
    /**
     * Return to Overview Activity with delete intent.
     */
    ...
    /**
     * Launch intent to pick a contact
     */
    ...
    /**
     * Delete contact in list used for list view as well as contact in taskEntity in view model
     */
    public void deleteContact(long contactID) {
        ...
        viewModel.removeFromContactsOfEntity(contactID); //also delete from entity, so the contact doesn't get saved
        listViewAdapter.notifyDataSetChanged();
    }

    /**
     * Start email sending intent
     */
    ...
    /**
     * Construct message for email/sms from task entity
     */
